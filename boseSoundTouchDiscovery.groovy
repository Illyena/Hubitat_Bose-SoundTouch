...
definition(
    ...
    importUrl: "https://raw.githubusercontent.com/Illyena/Hubitat_Bose-SoundTouch/refs/heads/main/boseSoundTouchDiscovery",
    iconUrl: "",
    iconX2Url: "",
    iconX3Url: "")
...
def installed()
{
    ...
    for(device in deviceList)
    {
        ...
        child = addChildDevice("Bose-SoundTouch", "Bose SoundTouch Device", device, [isComponent: true, name: "Bose SoundTouch Device", label: atomicState.devices[device]])
        if(child)
        {
